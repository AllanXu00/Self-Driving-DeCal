...
class Car_Interface():
    ...
    def __init__(self, model = "simple"):
        ...
        self.rolling_bias = 0.010026350482403114
        self.friction_constant = 0.1101003773386885

        self.accelerator_weight = 0.09999785376940937
        self.brake_weight = -0.2495182751695796
