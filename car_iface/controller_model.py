...
class Car_Interface():
    ...
    def __init__(self, model = "simple"):
        ...
        self.rolling_bias = 0.009948726292356247
        self.friction_constant = 0.1098788958428207

        self.accelerator_weight = 0.10002000669212774
        self.brake_weight = -0.24991289140138043
    ...
    def apply_control(self, pedal, amount):
        ...
        if (self.model == "simple"):
            ...
            accel_amt = amount if pedal is self.ACCELERATOR else 0
            brake_amt = amount if pedal is self.BRAKE else 0
            self.accel = self.accelerator_weight * accel_amt + self.brake_weight * brake_amt
        ...
        self.position += self.dt * self.velocity + self.dt * self.dt * self.accel / 2
